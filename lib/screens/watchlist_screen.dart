...
class _WatchlistScreenState extends State<WatchlistScreen> {
  ...
  Future<void> _loadWatchlist() async {
    final items = await WatchlistStorage.getItems();
    if (!mounted) return;
    setState(() {
      _items = items;
      _isLoading = false;
  ...
  Future<void> _removeFocused() async {
    ...
    await WatchlistStorage.removeItem(item.movieUrl);
  ...
  Widget build(BuildContext context) {
    return KeyEventHandler(
      ...
      onUpKey: () {
        ...
        final isTopGridRow = _items.isNotEmpty && _focusedIndex < _crossAxisCount(context);
          ...
          leading: Padding(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: _isBackButtonFocused ? const Color(0xFFFFC107) : Colors.transparent,
                  width: 2,
                ),
            ...
            : _items.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _buildWatchlistCard(item, isFocused);
                    },
                  ),
      ),
    );
    ...
    Widget _buildWatchlistCard(WatchlistItem item, bool isFocused) {
